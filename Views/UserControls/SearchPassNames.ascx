<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchPassNames.ascx.cs" Inherits="Views_UserControls_SearchPassNames" %>
                ...
                <asp:UpdatePanel ID="Up_FieldSelector" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:DropDownList ID="cmb_Fields" runat="server" CssClass="combobox" 
                            ...
                            <asp:ListItem Text="نام" Value="Name"></asp:ListItem>
                            <asp:ListItem Text="نوع اسم" Value="Type"></asp:ListItem>
                            <asp:ListItem Text="شرح اسم" Value="Description"></asp:ListItem>
                            <asp:ListItem Text="وضعیت" Value="Status"></asp:ListItem>
                            <asp:ListItem Text="پیشنهاد دهنده" Value="SuggestedBy"></asp:ListItem>
                            <asp:ListItem Text="تاریخ پیشنهاد" Value="DateOfSuggest"></asp:ListItem>
                            <asp:ListItem Text="شماره نامه پیشنهاد" Value="LetterNo"></asp:ListItem>
                        </asp:DropDownList>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
