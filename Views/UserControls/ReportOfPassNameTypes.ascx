<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReportOfPassNameTypes.ascx.cs" Inherits="Views_UserControls_ReportOfPassNameTypes" %>
...
<div class="table center">
    ...
    <asp:Chart ID="chart_Report" runat="server" Width="600px" Height="370px" BackColor="#f8f8f8" Visible="false">
        <Series>
