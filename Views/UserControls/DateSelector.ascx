...
<div style="display : inline;">
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <asp:DropDownList ID="cmb_Day" runat="server" CssClass="combobox2" Width="65">
            ...
            <td>
                <% if (EnableValidation)
                   {%>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="cmb_Day" runat="server" ErrorMessage="" CssClass="validator" ValidationGroup="SaveFormData"></asp:RequiredFieldValidator>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="cmb_Month" runat="server" ErrorMessage="" CssClass="validator" ValidationGroup="SaveFormData"></asp:RequiredFieldValidator>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="cmb_Year" runat="server" ErrorMessage="" CssClass="validator" ValidationGroup="SaveFormData"></asp:RequiredFieldValidator>
                <% } %>
            </td>
        </tr>
    </table>
